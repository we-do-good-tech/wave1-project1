...
class Court extends Component {
  ...
  HandleClick = (index) => {
    if (index == this.state.active) this.setState({ active: 0 });
            ...
            <div className="BubbleWrapper">
              <div className="CourtBubble">
                ...
                <p style={contentstyle}>
                  תיבת השחקן היא אחת משישה אזורים מסומנים וממסופרים,
                  <br />
                  מהם זורק השחקן.
                </p>
              </div>
          ...
          <div className="CourtMainDiv" onClick={() => this.setState({ active: 0 })}>
            ...
            <div className="BubbleWrapper">
              <div className="CourtBubble">
                ...
                <p style={contentstyle}>
                  הקו המסומן במגרש ומאחוריו יושבים השחקנים שזורקים את הכדור.
                </p>
              </div>
            </div>
          ...
          <div className="CourtMainDiv" onClick={() => this.setState({ active: 0 })}>
            ...
            <div className="BubbleWrapper">
              <div className="CourtBubble">
                ...
                <p style={contentstyle}>
                  הקו שהכדור הלבן חייב לעבור במלואו ולהימצא מאחוריו, על מנת שיחשב כ"במשחק".
                </p>
              </div>
            </div>
          ...
          <div className="CourtMainDiv" onClick={() => this.setState({ active: 0 })}>
            ...
            <div className="BubbleWrapper">
              <div className="CourtBubble">
                ...
                <p style={contentstyle}>המגרש פחות תיבות השחקנים.</p>
              </div>
            </div>
          ...
          <div className="CourtMainDiv" onClick={() => this.setState({ active: 0 })}>
            ...
            <div className="BubbleWrapper">
              <div className="CourtBubble">
                ...
                <p style={contentstyle}>ריבוע בגודל של 25X25 ס"מ במרכז המגרש, לכדורי עונשין.</p>
              </div>
            </div>
