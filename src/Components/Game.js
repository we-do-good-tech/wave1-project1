...
class Game extends Component {
  ...
  movered = (a, b, speed, index) => {
    ...
    if (x - a > 0) ysteps = this.calcy(y, b, x - a);
    ...
    const myinter = setInterval(() => {
      if (this.state.redballs[index][0] != a) {
        ...
        y += ysteps;
        const prevBalls = this.state.redballs.concat();
        const newxy = [x, y];
  ...
  moveblue = (a, b, speed, index) => {
    ...
    const myinter = setInterval(() => {
      if (this.state.blueballs[index][0] != a) {
        ...
        y += ysteps;
        const prevBalls = this.state.blueballs.concat();
        const newxy = [x, y];
        prevBalls[index] = newxy;
  ...
  getMove = () => {
    ...
    if (this.state.active == 0) this.ActivePlusOne();

    if (this.state.active == 6) this.reset();
  };
      ...
      return (
        <div className="MalePlayerDiv">
          <p className="MalePlayerBubble">
            ...
            <h1 style={{ 'font-size': 'calc(0.7vw + 0.9vh)', 'letter-spacing': '0.07vw' }}>
              המשחק מתחיל כאשר השחקן
              <br /> שמשחק בכדורים האדומים,
              <br /> זורק את הכדור הלבן אל עבר המגרש.
            </h1>
            <h2
              style={{
                'font-size': 'calc(0.65vw + 0.8vh)',
                'letter-spacing': '0.07vw',
                'font-weight': '300',
              }}
            >
              לחצו בכל מקום על גבי המגרש
              <br /> על מנת לזרוק את הכדור הלבן.
            </h2>
          </p>
      ...
      return (
        <div className="MalePlayerDiv">
          <p className="MalePlayerBubbleFirstAlt">
            ...
            <h1 style={{ 'font-size': 'calc(0.7vw + 0.9vh)', 'letter-spacing': '0.07vw' }}>
              השחקן שזרק את הכדור הלבן
              <br /> יזרוק את הכדור האדום הראשון.
            </h1>
            <h2
              style={{
                'font-size': 'calc(0.65vw + 0.8vh)',
            ...
            >
              לחצו בכל מקום על גבי המגרש
              <br /> על מנת לזרוק את הכדור האדום הראשון{' '}
            </h2>
          </p>
          <img src={FirstPlayer} style={{ height: 'calc(10vh + 10vw)' }} />
        </div>
      ...
      return (
        <div className="MalePlayerDiv">
          <p className="MalePlayerBubbleSecondAlt">
            ...
            <h1 style={{ 'font-size': 'calc(0.7vw + 0.9vh)', 'letter-spacing': '0.07vw' }}>
              הצד שהכדור שלו רחוק יותר מהכדור הלבן הוא זה שימשיך לזרוק. לדוגמא: היות והכדור הכחול
              קרוב יותר לכדור הלבן, הצד האדום יזרוק כדור נוסף.{' '}
            </h1>
            <h2
              style={{
                'font-size': 'calc(0.65vw + 0.8vh)',
            ...
            >
              לחצו בכל מקום על גבי המגרש
              <br /> על מנת לזרוק כדור אדום נוסף.
            </h2>
          </p>
          <img src={FirstPlayer} style={{ height: 'calc(10vh + 10vw)' }} />
        </div>
      ...
      return (
        <div className="MalePlayerDiv">
          <p className="MalePlayerBubbleThirdAlt">
            ...
            <h1 style={{ 'font-size': 'calc(0.7vw + 0.9vh)', 'letter-spacing': '0.07vw' }}>
              במידה והכדור הכחול עדיין קרוב יותר לכדור הלבן, האדום יזרוק כדור נוסף וכן הלאה...
            </h1>
          </p>
          <img src={FirstPlayer} style={{ height: 'calc(10vh + 10vw)' }} />
        </div>
      ...
      return (
        <div className="FemalePlayerDiv">
          <p className="FemalePlayerBubble">
            ...
            <h1 style={{ 'font-size': 'calc(0.7vw + 0.9vh)', 'letter-spacing': '0.07vw' }}>
              השחקן שמשחק בכדורים הכחולים
              <br /> יזרוק כדור כחול ראשון.
            </h1>
            <h2
              style={{
                'font-size': 'calc(0.65vw + 0.8vh)',
            ...
            >
              לחצו בכל מקום על גבי המגרש
              <br /> על מנת לזרוק את הכדור הכחול הראשון.
            </h2>
          </p>
    ...
    if (this.state.active == 0) {
      return (
        <p className="Situation">
          ...
          <h2>
            לחצו בכל מקום על גבי המגרש כדי
            <br /> להתחיל את המשחק.
          </h2>
        </p>
      );
