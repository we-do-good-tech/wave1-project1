...
class PopUp extends Component {
  ...
  componentWillUpdate(newProps, newState) {
    if (newProps.display !== this.state.display) this.setState({ display: newProps.display });
    ...
    switch (this.state.level) {
      case 1: {
        return (
          <div
            id="explanationDiv"
            style={{ display: visibility ? 'block' : 'none', width: '14vw' }}
          >
      ...
      case 2: {
        return (
          <div id="explanationDiv" style={{ display: visibility ? 'block' : 'none' }}>
            <h1>בחן את עצמך</h1>
            <p>
              לאורך כל הלומדה תוכל לבחון את עצמך.
              <br />
              באפשרותך לבחור האם בתחילת הפרק,
              <br /> באמצע או בסוף.
            </p>
