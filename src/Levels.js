 ...
 [
  {
    ...
    Answers:["אסטרטג, דיוק ", " יצירתיות, הישגיות", " תחרותיות, עמידה בלחצים " , " יכולת ריכוז גבוהה, פתיחות מחשבתית"],
    Kind:4,
    Explanation:"אם הייתם בוחרים בכל תשובה אחרת גם הייתם צודקים (אולי איזה סמיילי). לאלופי העולם בבוצ'ה יש את כל התכונות האלו."
