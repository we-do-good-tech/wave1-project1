			...
			if(this.state.active==2)
			{
				return(
					<div id="WhatIsContentDiv">
								...
								חר כך זורקת הקבוצה הכחולה את הכדור הכחול הראשון שלה, במטרה להתקרב כמה שיותר לכדור הלבן. <br/>
		...
		return(
			<body>
				...
				<div className="sidenavbar" >
		           ...
		           <p className="sidenavtabs"> <a href="./#/">סיווגים</a></p>
