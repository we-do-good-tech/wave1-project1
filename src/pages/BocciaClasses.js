...
class BocciaClasses extends Component {
  ...
  <div className="ContentDivClasses" style={{width:'44vw',height:'70vh'}}>
    ...
    <p className="ContentText">
      <strong>	השפעת הלקות על השריר |</strong>
      {' '}
      שליטה נמוכה בשרירי הליבה והגו.
      {' '}
    </p>
    <p className="ContentText">
    ...
    <p className="ContentText">
      <strong>	ניידות |</strong>
      {' '}
      לרוב ניידים בכיסא גלגלים חשמלי.
    </p>
    <p className="ContentText">
      <strong>סיוע |</strong>
      {' '}
      רשאים לליווי עוזר ספורט במגרש להנגשת הכדורים.
    </p>
  ...
  <div className="ContentDivClasses" style={{width:'44vw',height:'60vh'}}>
    ...
    <p className="ContentText">
      <strong>	השפעת הלקות על השריר |</strong>
      {' '}
      שליטה נמוכה – סבירה בשרירי הליבה והגו.
    </p>
    <p className="ContentText">
      <strong>	השפעת הלקות על התנועה | </strong>
    ...
    <p className="ContentText">
      <strong>	ניידות |</strong>
      {' '}
      לרוב ניידים בכיסא גלגלים ידני (ייתכן גם ממונע), חלקם מסוגלים ללכת.
    </p>
    <p className="ContentText">
      <strong>סיוע | </strong>
  ...
  <div className="ContentDivClasses" style={{width:'44vw',height:'60vh'}}>
    ...
    <p className="ContentText">
      <strong>השתייכות לקלאס | </strong>
      {' '}
      ספורטאים בעלי לקות משמעותית ביותר בכל ארבע הגפיים.
    </p>
    <p className="ContentText">
      <strong>אופי הלקות | </strong>
    ...
    <p className="ContentText">
      <strong>	השפעת הלקות על השריר |</strong>
      {' '}
      מגוון רחב של השפעות כתלות בסוג ומידת הפגיעה.
    </p>
    <p className="ContentText">
      <strong>	השפעת הלקות על התנועה | </strong>
      אין אפשרות של אחיזה או בעיטה של הכדור, לא מתאפשרת זריקה של הכדור באופן עקבי ומכוון לטווח של כ-5 מטרים.
    </p>
    <p className="ContentText">
      <strong>	ניידות |</strong>
      {' '}
    ...
    <p className="ContentText">
      <strong>סיוע | </strong>
      מלווים על ידי עוזר ספורט במגרש. לצורך שחרור הכדור נעזרים ברמפה המתופעלת ע"י עוזר ספורט המונחה על ידי השחקן ואינו רשאי להפנות פניו למגרש.
    </p>
    <br />
  ...
  <div className="ContentDivClasses" style={{width:'44vw',height:'60vh'}}>
    ...
    <p className="ContentText">
      <strong>השתייכות לקלאס | </strong>
      {' '}
      ספורטאים בעלי פגיעות גופניות שונות שאינן CP.
    </p>
    <p className="ContentText">
      <strong>אופי הלקות | </strong>
    ...
    <p className="ContentText">
      <strong>	השפעת הלקות על השריר |</strong>
      {' '}
      שליטה נמוכה ביותר בשרירי הליבה, הגו והידיים.
    </p>
    <p className="ContentText">
      <strong>	השפעת הלקות על התנועה | </strong>
    ...
    <p className="ContentText">
      <strong>	ניידות |</strong>
      {' '}
      לרוב ניידים בכיסא גלגלים ידני (ייתכן גם ממונע).
    </p>
    <p className="ContentText">
      <strong>סיוע | </strong>
      {' '}
      אינם רשאים לליווי עוזר ספורט במגרש להנגשת הכדורים (חוץ מהשחקנים הבועטים).
    </p>
  ...
  <div className="ContentDivClasses" style={{width:'44vw',height:'60vh'}}>
    ...
    <p className="ContentText">
      <strong>השתייכות לקלאס | </strong>
      {' '}
      ספורטאים בעלי לקות בכל ארבע הגפיים (דומה לסיווג BC4 אבל קל יותר).
    </p>
    <p className="ContentText">
      <strong>אופי הלקות | </strong>
      {' '}
      מתאפשר טווח תנועה פונקציונלי רחב יותר, וספסטיות נמוכה יותר.
    </p>
    <p className="ContentText">
      <strong>	השפעת הלקות על השריר |</strong>
      {' '}
      שליטה גבוהה בשרירי הליבה והגו.
    </p>
    <p className="ContentText">
      <strong>	השפעת הלקות על התנועה | </strong>
      {' '}
      ישנה יכולת אחיזה בכדור.
    </p>
    <p className="ContentText">
      <strong>	ניידות |</strong>
      {' '}
      מתניידים עצמאית, על פי רוב מסוגלים ללכת ללא אמצעי עזר או בתמיכה קלה.
    </p>
    <p className="ContentText">
      <strong>סיוע | </strong>
      {' '}
    ...
    <img className="ContentPic" style={{width:'calc(13vw + 17vh)', top:'14vh'}} src={BC5} />						
		...
		const GetDivFrontBack= () => {
			if(this.state.active===this.state.names.length){
				return(
  <FrontBack moveTo={3} last onClick={this.handlearrow} />
				);
			}
			if(this.state.active===1){
				return(
  <FrontBack moveTo={3} first onClick={this.handlearrow} />
				)
			}
