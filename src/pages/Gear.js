			...
			if(this.state.active==2)
			{
				return(
					<div id="GearMainButtonDiv">
						<button className="GearMainButton GearMainButtonActive rightcurved"><p>כדורים</p></button>
						<button className="GearMainButton"><p>רמפה</p></button>
						<button className="GearMainButton"><p>מחבט</p></button>	
			...
			if(this.state.active==3)
				{
					return(
						<div id="GearMainButtonDiv">
							<button className="GearMainButton rightcurved"><p>כדורים</p></button>
							<button className="GearMainButton GearMainButtonActive"><p>רמפה</p></button>
							<button className="GearMainButton"><p>מחבט</p></button>	
							<button className="GearMainButton leftcurved"><p>תרגול</p></button>
						</div>
					);
			...
			if(this.state.active==4)
				{
					return(
						<div id="GearMainButtonDiv">
							<button className="GearMainButton rightcurved"><p>כדורים</p></button>
							<button className="GearMainButton"><p>רמפה</p></button>
							<button className="GearMainButton GearMainButtonActive"><p>מחבט</p></button>	
							<button className="GearMainButton leftcurved"><p>תרגול</p></button>
						</div>
					);
				}	
				...
				return(
					<div id="GearContentDivFirstState">
						...
						<div id="GearContentDivFirstStatePage">
								<button className="GearFirstStatePageButton" onClick={this.handleclick} value="2">01<br/>כדורים</button>
								<button className="GearFirstStatePageButton" onClick={this.handleclick} value="3">02<br/>רמפה</button>
								<button className="GearFirstStatePageButton" onClick={this.handleclick} value="4">03<br/>מחבט</button>
		...
		<div>
			<div className="sidenavbar" >
	        	...
	        	<p className="sidenavtabs"> <a href="./#/BocciaClasses">סיווגים</a></p>
	         	...
	         	<p className="activesidenavtabs sidenavtabs"> <a href="./#/Gear">ציוד</a></p>
