    ...
    <div id="MeetThePlayersMain">	
      ...
      <div id="InTheMedia">
        ...
        <ul id="LookForUs">
          ...
          <li id="IGlist">
            <img src={Instagram} />
            <a href="https://www.instagram.com/para_israel/" target="_blank">para_israel</a>
          </li>
          <li id="FBlist">
            <img src={Facebook} />
            <a href="https://www.facebook.com/bocciaIl" target="_blank">עמותת הבוצ'ה לנכים בישראל  </a>
          </li>	
        </ul>
      </div>
