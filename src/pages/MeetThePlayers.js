...
class MeetThePlayers extends Component {
  ...
  HandlePopUp = (toactive) => {
    ...
    if (this.state.PopUpDisplay === 'none') this.setState({ PopUpDisplay: 'flex' });
  ...
  getPopUp = () => {
    ...
    return (
      <div id="MediaPopUpWrapper" style={{ display: this.state.PopUpDisplay }}>
        <div id="MediaPopUp">
          <p id="rightarrow" onClick={() => this.handlearrow(1)}>
            V
          </p>
          <img id="MediaX" onClick={() => this.HandlePopUp()} src={XButton} />
          {PopUpContent[this.state.active]}
          <p id="leftarrow" onClick={() => this.handlearrow(2)}>
            V
          </p>
        </div>
      </div>
        ...
        <div id="MeetThePlayersMain">
          ...
          <div id="InTheMedia">
            <div
              ...
              onClick={() => this.HandlePopUp(0)}
              style={{ 'background-image': `url(${NadavVideo})` }}
            >
              <p>נדב לוי שחקן בוצ'ה פאראלימפי</p>
            </div>

            <div
              className="Achievment"
              onClick={() => this.HandlePopUp(1)}
              style={{ 'background-image': `url(${BocciaVideo})` }}
            >
              <p>מה זה בוצ'ה?</p>
            </div>
            ...
            <div
              className="Achievment"
              onClick={() => this.HandlePopUp(2)}
              style={{ 'background-image': `url(${GershonChamp})` }}
            >
              <p>גרשון חיימוב אלוף ישראל</p>
            </div>

            <div
              className="Achievment"
              onClick={() => this.HandlePopUp(3)}
              style={{ 'background-image': `url(${NewChamp})` }}
            >
              <p>האלופה החדשה של ישראל BC1</p>
            </div>

            <div
              className="Achievment"
              onClick={() => this.HandlePopUp(4)}
              style={{ 'background-image': `url(${KickToLive})` }}
            >
              <p>לבעוט זה לחיות</p>
            </div>

            <div className="Achievment" onClick={() => this.HandlePopUp(5)}>
              <p>נדב לוי רביעי באירופה</p>
              <img src={NadavFourth} />
            </div>
          </div>
          ...
          <div id="InTheMedia">
            ...
            <ul id="LookForUs">
              ...
              <li id="IGlist">
                <img src={Instagram} />
                <a href="https://www.instagram.com/para_israel/" target="_blank">
                  para_israel
                </a>
              </li>
              <li id="FBlist">
                <img src={Facebook} />
                <a href="https://www.facebook.com/bocciaIl" target="_blank">
                  עמותת הבוצ'ה לנכים בישראל{' '}
                </a>
              </li>
            </ul>
          </div>
